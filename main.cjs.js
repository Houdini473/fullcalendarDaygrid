...
var TableRow = /** @class */ (function (_super) {
      ...
      props.cells.map(function (cell, col) {
        ...
        return common.createElement(TableCell, {
          ...
          onMoreClick: function (arg) {
            props.onMoreClick(
              tslib.__assign(tslib.__assign({}, arg), { fromCol: col })
            );
          },
          segIsHidden: segIsHidden,
  ...
  TableRow.prototype.renderFillSegs = function (segs, fillType) {
    ...
    return common.createElement.apply(
      void 0,
      tslib.__spreadArrays([common.Fragment, {}], nodes)
    );
  };
...
var Popover = /** @class */ (function (_super) {
  ...
  Popover.prototype.render = function () {
    ...
    return common.createElement(
      "div",
      tslib.__assign({ className: classNames.join(" ") }, props.extraAttrs, {
  ...
  function Table() {
    ...
    _this.handleMoreLinkClick = function (arg) {
      ...
      if (!clickOption || clickOption === "popover") {
        _this.setState({
          morePopoverState: tslib.__assign(tslib.__assign({}, arg), {
        ...
        function (nowDate, todayRange) {
          return common.createElement(
                  ...
                  return common.createElement(TableRow, {
                    ...
                    onMoreClick: function (arg) {
                      _this.handleMoreLinkClick(
                        tslib.__assign(tslib.__assign({}, arg), {
                          fromRow: row,
                        })
                      );
                    },
            ...
            !props.forPrint &&
              ...
              common.createElement(MorePopover, {
