...
declare abstract class TableView<State = Dictionary> extends DateComponent<
  ViewProps,
  State
> {
...
declare function buildDayTableModel(
...
declare type MoreLinkSimpleAction =
  | "popover"
  | "week"
  | "day"
  | "timeGridWeek"
...
declare const OPTION_REFINERS: {
  ...
  moreLinkWillUnmount: Identity<
    WillUnmountHandler<MountArg<MoreLinkContentArg>>
  >;
};
